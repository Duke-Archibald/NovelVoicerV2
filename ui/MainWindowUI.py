...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tv_lines = QTableViewP(self.centralwidget)
        ...
        self.tv_lines_split = QtWidgets.QTableView(self.centralwidget)
        ...
        self.l_novel = QtWidgets.QLabel(self.centralwidget)
        self.l_novel.setObjectName("l_novel")
        self.horizontalLayout_2.addWidget(self.l_novel)
        self.cb_novel = QtWidgets.QComboBox(self.centralwidget)
        ...
        self.l_chapter = QtWidgets.QLabel(self.centralwidget)
        ...
        self.checkbox_complete = QtWidgets.QCheckBox(self.centralwidget)
        ...
        self.cb_chapter = QtWidgets.QComboBox(self.centralwidget)
        ...
        self.pb_save_chapter = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.pb_complete_chapter = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.l_character_name = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pb_make_todo = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.pb_revert = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.dw_characters = QDockWidgetTEST(MainWindow)
        self.dw_characters.setFloating(False)
        self.dw_characters.setFeatures(QtWidgets.QDockWidget.AllDockWidgetFeatures)
        ...
        self.pb_show_mod = QtWidgets.QPushButton(self.dockWidgetContents_3)
        self.pb_show_mod.setObjectName("pb_show_mod")
        self.gridLayout.addWidget(self.pb_show_mod, 0, 0, 1, 1)
        self.tv_characters = QtWidgets.QTableView(self.dockWidgetContents_3)
        ...
        self.dw_stats = QDockWidgetTEST(MainWindow)
        self.dw_stats.setFloating(False)
        self.dw_stats.setFeatures(QtWidgets.QDockWidget.AllDockWidgetFeatures)
        self.dw_stats.setAllowedAreas(QtCore.Qt.AllDockWidgetAreas)
        ...
        self.pb_interactive = QtWidgets.QPushButton(self.dockWidgetContents_2)
        self.pb_interactive.setObjectName("pb_interactive")
        self.gl_stats.addWidget(self.pb_interactive, 0, 0, 1, 1)
        self.cbox_chapter = QtWidgets.QCheckBox(self.dockWidgetContents_2)
        ...
        self.dw_progression = QDockWidgetTEST(MainWindow)
        ...
        self.prbr_chapter = QtWidgets.QProgressBar(self.dockWidgetContents_4)
        ...
        self.prbr_TTS = QtWidgets.QProgressBar(self.dockWidgetContents_4)
        ...
        self.prbr_novel = QtWidgets.QProgressBar(self.dockWidgetContents_4)
        ...
        self.dw_info = QDockWidgetTEST(MainWindow)
        ...
        self.l_con_isValid = QtWidgets.QLabel(self.dockWidgetContents_5)
        ...
        self.l_con_last_query = QtWidgets.QLabel(self.dockWidgetContents_5)
        self.l_con_last_query.setWordWrap(True)
        self.l_con_last_query.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextSelectableByMouse)
        ...
        self.label_4 = QtWidgets.QLabel(self.dockWidgetContents_5)
        self.label_4.setObjectName("label_4")
        self.gridLayout_6.addWidget(self.label_4, 3, 0, 1, 1)
        self.l_con_last_error = QtWidgets.QLabel(self.dockWidgetContents_5)
        self.l_con_last_error.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextSelectableByMouse)
        ...
        self.label_5 = QtWidgets.QLabel(self.dockWidgetContents_5)
        self.label_5.setObjectName("label_5")
        self.gridLayout_6.addWidget(self.label_5, 2, 0, 1, 1)
        self.l_con_computer_name = QtWidgets.QLabel(self.dockWidgetContents_5)
        self.l_con_computer_name.setObjectName("l_con_computer_name")
        self.gridLayout_6.addWidget(self.l_con_computer_name, 4, 1, 1, 1)
        self.l_con_is_admin = QtWidgets.QLabel(self.dockWidgetContents_5)
        ...
        self.dw_tts = QDockWidgetTEST(MainWindow)
        self.dw_tts.setFloating(False)
        self.dw_tts.setFeatures(QtWidgets.QDockWidget.AllDockWidgetFeatures)
        ...
        self.pb_start_tts = QtWidgets.QPushButton(self.dockWidgetContents_6)
        ...
        self.tableView = QtWidgets.QTableView(self.dockWidgetContents_6)
        ...
        self.label = QtWidgets.QLabel(self.dockWidgetContents_7)
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.gridLayout_3.addWidget(self.label, 1, 0, 1, 1)
        self.formLayout = QtWidgets.QFormLayout()
        self.formLayout.setObjectName("formLayout")
        self.label_25 = QtWidgets.QLabel(self.dockWidgetContents_7)
        self.label_25.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_25.setObjectName("label_25")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_25)
        self.le_char_character_name = QtWidgets.QLineEdit(self.dockWidgetContents_7)
        self.le_char_character_name.setText("")
        self.le_char_character_name.setObjectName("le_char_character_name")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.le_char_character_name)
        self.label_26 = QtWidgets.QLabel(self.dockWidgetContents_7)
        self.label_26.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_26.setObjectName("label_26")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_26)
        self.cb_char_novel = QtWidgets.QComboBox(self.dockWidgetContents_7)
        self.cb_char_novel.setObjectName("cb_char_novel")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.cb_char_novel)
        self.label_27 = QtWidgets.QLabel(self.dockWidgetContents_7)
        self.label_27.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_27.setObjectName("label_27")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_27)
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.le_char_color = QtWidgets.QLineEdit(self.dockWidgetContents_7)
        self.le_char_color.setObjectName("le_char_color")
        self.horizontalLayout_8.addWidget(self.le_char_color)
        self.pb_char_color = QtWidgets.QPushButton(self.dockWidgetContents_7)
        ...
        self.cb_char_importances = QtWidgets.QComboBox(self.dockWidgetContents_7)
        self.cb_char_importances.setObjectName("cb_char_importances")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.cb_char_importances)
        self.label_28 = QtWidgets.QLabel(self.dockWidgetContents_7)
        ...
        self.label_20 = QtWidgets.QLabel(self.dockWidgetContents_7)
        self.label_20.setObjectName("label_20")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_20)
        self.cb_char_country = QtWidgets.QComboBox(self.dockWidgetContents_7)
        self.cb_char_country.setEditable(True)
        self.cb_char_country.setInsertPolicy(QtWidgets.QComboBox.NoInsert)
        self.cb_char_country.setObjectName("cb_char_country")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.cb_char_country)
        self.label_22 = QtWidgets.QLabel(self.dockWidgetContents_7)
        self.label_22.setObjectName("label_22")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_22)
        self.cb_char_type = QtWidgets.QComboBox(self.dockWidgetContents_7)
        self.cb_char_type.setObjectName("cb_char_type")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.cb_char_type)
        self.label_23 = QtWidgets.QLabel(self.dockWidgetContents_7)
        self.label_23.setObjectName("label_23")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_23)
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.cb_char_name = QtWidgets.QComboBox(self.dockWidgetContents_7)
        self.cb_char_name.setEditable(True)
        self.cb_char_name.setInsertPolicy(QtWidgets.QComboBox.NoInsert)
        self.cb_char_name.setObjectName("cb_char_name")
        self.horizontalLayout_7.addWidget(self.cb_char_name)
        self.cb_char_voice_code = QtWidgets.QComboBox(self.dockWidgetContents_7)
        ...
        self.cb_char_gender = QtWidgets.QComboBox(self.dockWidgetContents_7)
        self.cb_char_gender.setObjectName("cb_char_gender")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.cb_char_gender)
        self.cb_char_service = QtWidgets.QComboBox(self.dockWidgetContents_7)
        self.cb_char_service.setObjectName("cb_char_service")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.cb_char_service)
        self.label_21 = QtWidgets.QLabel(self.dockWidgetContents_7)
        self.label_21.setObjectName("label_21")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_21)
        self.label_24 = QtWidgets.QLabel(self.dockWidgetContents_7)
        ...
        self.pb_char_test_voice = QtWidgets.QPushButton(self.dockWidgetContents_7)
        ...
        self.pb_char_add = QtWidgets.QPushButton(self.dockWidgetContents_7)
        ...
        self.pb_char_edit = QtWidgets.QPushButton(self.dockWidgetContents_7)
        ...
        self.actionProgress = QtWidgets.QAction(MainWindow)
        ...
        self.actionTTS = QtWidgets.QAction(MainWindow)
